...
create table "courses" ("id" INTEGER NOT NULL PRIMARY KEY AUTO_INCREMENT,"grade_id" INTEGER NOT NULL,"name" VARCHAR NOT NULL UNIQUE,"started" DATE NOT NULL,"completed" DATE NOT NULL)
