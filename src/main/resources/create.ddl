...
create table "assignments" ("id" INTEGER NOT NULL PRIMARY KEY AUTO_INCREMENT,"course_id" INTEGER NOT NULL,"task" VARCHAR NOT NULL,"assigned" TIMESTAMP NOT NULL,"completed" TIMESTAMP NOT NULL,"score" DOUBLE NOT NULL)
