...
create table "courses" ("id" INTEGER NOT NULL PRIMARY KEY AUTO_INCREMENT,"grade_id" INTEGER NOT NULL,"name" VARCHAR NOT NULL,"website" VARCHAR)
create table "assignments" ("id" INTEGER NOT NULL PRIMARY KEY AUTO_INCREMENT,"course_id" INTEGER NOT NULL,"task" VARCHAR NOT NULL,"assigned" TIMESTAMP NOT NULL,"completed" TIMESTAMP,"score" DOUBLE NOT NULL)
