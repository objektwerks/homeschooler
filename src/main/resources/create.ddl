create table "students" ("id" INTEGER NOT NULL PRIMARY KEY AUTO_INCREMENT,"name" VARCHAR NOT NULL,"email" VARCHAR NOT NULL UNIQUE,"born" TIMESTAMP NOT NULL)
create table "grades" ("id" INTEGER NOT NULL PRIMARY KEY AUTO_INCREMENT,"student_id" INTEGER NOT NULL,"grade" INTEGER NOT NULL,"started" TIMESTAMP NOT NULL,"completed" TIMESTAMP NOT NULL)
