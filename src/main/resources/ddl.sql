...
create table "courses" ("id" INTEGER NOT NULL PRIMARY KEY AUTO_INCREMENT,"grade_id" INTEGER NOT NULL,"name" VARCHAR NOT NULL,"started" DATE NOT NULL,"completed" DATE NOT NULL)
