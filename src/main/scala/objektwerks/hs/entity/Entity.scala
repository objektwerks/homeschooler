...
case class Grade(id: Int = 0, studentid: Int, year: String = "default_grade", started: LocalDate = LocalDate.now,
                 completed: LocalDate = LocalDate.now.plusMonths(6))
case class Course(id: Int = 0, gradeid: Int, name: String = "default_course", started: LocalDate = LocalDate.now,
                  completed: LocalDate = LocalDate.now.plusMonths(3))
case class Assignment(id: Int = 0, courseid: Int, task: String = "default_assignment", assigned: LocalDate = LocalDate.now,
                      completed: LocalDate = LocalDate.now, score: Double = 50.0)
